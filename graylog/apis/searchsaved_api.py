...
class SearchsavedApi(object):
    ...
    def create(self, json_body, **kwargs):
        ...
        :param CreateSavedSearchRequest json_body:  (required)
        :return: None
    ...
    def create_with_http_info(self, json_body, **kwargs):
        ...
        resource_path = '/search/saved'.replace('{format}', 'json')
        path_params = {}
    ...
    def delete(self, search_id, **kwargs):
        ...
        :param callback function: The callback function
            for asynchronous request. (optional)
        :param Object search_id:  (required)
        :return: None
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.delete_with_http_info(search_id, **kwargs)
        else:
            (data) = self.delete_with_http_info(search_id, **kwargs)
            return data
    ...
    def delete_with_http_info(self, search_id, **kwargs):
        ...
        if ('search_id' not in params) or (params['search_id'] is None):
            raise ValueError("Missing the required parameter `search_id` when calling `delete`")

        resource_path = '/search/saved/{searchId}'.replace('{format}', 'json')
        path_params = {}
    ...
    def get(self, search_id, **kwargs):
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.get_with_http_info(search_id, **kwargs)
        else:
            (data) = self.get_with_http_info(search_id, **kwargs)
            return data
    ...
    def get_with_http_info(self, search_id, **kwargs):
        ...
        # verify the required parameter 'search_id' is set
        if ('search_id' not in params) or (params['search_id'] is None):
            raise ValueError("Missing the required parameter `search_id` when calling `get`")
    ...
    def update(self, search_id, json_body, **kwargs):
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.update_with_http_info(search_id, json_body, **kwargs)
        else:
            (data) = self.update_with_http_info(search_id, json_body, **kwargs)
            return data
    ...
    def update_with_http_info(self, search_id, json_body, **kwargs):
        ...
        all_params = ['search_id', 'json_body']
        all_params.append('callback')
        all_params.append('_return_http_data_only')
        ...
        # verify the required parameter 'search_id' is set
        if ('search_id' not in params) or (params['search_id'] is None):
            raise ValueError("Missing the required parameter `search_id` when calling `update`")
        # verify the required parameter 'json_body' is set
        if ('json_body' not in params) or (params['json_body'] is None):
