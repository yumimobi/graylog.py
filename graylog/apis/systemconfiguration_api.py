...
class SystemconfigurationApi(object):
    ...
    def get_relevant(self, **kwargs):
        ...
        if kwargs.get('callback'):
            return self.get_relevant_with_http_info(**kwargs)
        else:
            (data) = self.get_relevant_with_http_info(**kwargs)
            return data
    ...
    def get_relevant_with_http_info(self, **kwargs):
        ...
        return self.api_client.call_api(resource_path, 'GET',
                                            ...
                                            response_type='ExposedConfiguration',
