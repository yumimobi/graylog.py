...
class SystemdeflectorApi(object):
    """
    ...
    def cycle_with_http_info(self, **kwargs):
        ...
        resource_path = '/system/deflector/cycle'.replace('{format}', 'json')
        path_params = {}
    ...
    def deflector(self, **kwargs):
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.deflector_with_http_info(**kwargs)
        else:
            (data) = self.deflector_with_http_info(**kwargs)
            return data
    ...
    def deflector_with_http_info(self, **kwargs):
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method deflector" % key
                )
            params[key] = val
        del params['kwargs']

        resource_path = '/system/deflector'.replace('{format}', 'json')
        path_params = {}
        ...
        return self.api_client.call_api(resource_path, 'GET',
                                            ...
                                            post_params=form_params,
                                            files=local_var_files,
                                            response_type='DeflectorSummary',
                                            auth_settings=auth_settings,
                                            callback=params.get('callback'),
                                            _return_http_data_only=params.get('_return_http_data_only'))
