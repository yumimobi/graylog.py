...
class SystemthroughputApi(object):
    """
    ...
    def total(self, **kwargs):
        ...
        if kwargs.get('callback'):
            return self.total_with_http_info(**kwargs)
        else:
            (data) = self.total_with_http_info(**kwargs)
            return data
    ...
    def total_with_http_info(self, **kwargs):
        ...
        resource_path = '/system/throughput'.replace('{format}', 'json')
        path_params = {}
