...
class PluginsorggraylogpluginsusagestatisticsApi(object):
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method show_cluster_data_set" % key
                )
            params[key] = val
        del params['kwargs']
    ...
    def show_config_with_http_info(self, **kwargs):
        ...
        return self.api_client.call_api(resource_path, 'GET',
                                            ...
                                            post_params=form_params,
                                            files=local_var_files,
                                            response_type='UsageStatsConfigurationResponse',
                                            auth_settings=auth_settings,
                                            callback=params.get('callback'),
                                            _return_http_data_only=params.get('_return_http_data_only'))
    ...
    def show_node_data_set_with_http_info(self, **kwargs):
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method show_node_data_set" % key
                )
            params[key] = val
        del params['kwargs']
